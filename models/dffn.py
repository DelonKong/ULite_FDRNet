...
def dffn(dataset, patch_size):
    ...
    if dataset == 'sa':
        ...
        model = DFFN(bands=274, classes=16, layers_num=[4,4,4])
    elif dataset == 'whuhh':
        model = DFFN(bands=270, classes=22, layers_num=[4,4,4])
    elif dataset == 'BS':
        ...
        model = DFFN(bands=102, classes=9, layers_num=[4,4,4])
...
if __name__ == '__main__':
    ...
    net = dffn(dataset='IP', patch_size=7)
