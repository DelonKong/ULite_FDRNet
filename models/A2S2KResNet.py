...
class S3KAIResNet(nn.Module):
    def __init__(self, band, classes, PARAM_KERNEL_SIZE=24, reduction=2):
...
def A2S2KResNet(dataset, patch_size):
    model = None
    if dataset == 'sa':
        model = S3KAIResNet(band=204, classes=16)
    elif dataset == 'pu':
        model = S3KAIResNet(band=103, classes=9)
    elif dataset == 'whulk':
        model = S3KAIResNet(band=270, classes=9)
    elif dataset == 'whuhh':
        model = S3KAIResNet(band=270, classes=22)
    elif dataset == 'hrl':
        model = S3KAIResNet(band=176, classes=14)
    elif dataset == 'IP':
        model = S3KAIResNet(band=200, classes=16)
    elif dataset == 'whuhc':
        model = S3KAIResNet(band=274, classes=16)
    elif dataset == 'BS':
        model = S3KAIResNet(band=145, classes=14)
    elif dataset == 'HsU':
        model = S3KAIResNet(band=144, classes=15)
    elif dataset == 'KSC':
        model = S3KAIResNet(band=176, classes=13)
    elif dataset == 'pc':
        model = S3KAIResNet(band=102, classes=9)
...
if __name__ == '__main__':
    ...
    net = A2S2KResNet(dataset='whulk', patch_size=9)
